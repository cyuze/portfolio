...
$('.Second_slider').slick({
    ...
    slidesToScroll: 1,
    arrows: true,
    prevArrow: '<button class="slick-prev"><img src="./ポートフォリオ/left.png" alt="Prev"></button>',
    nextArrow: '<button class="slick-next"><img src="./ポートフォリオ/right.png" alt="Next"></button>',
    fade: true,
    asNavFor: '.Top_slider'
});
...
const texts4 = ["スキー場の近くにあります。クロスカントリースキー部だった小学生時代に、部活帰りに食べた一杯が冷え切った体を温めてくれました。人生ではじめ何かを頑張ろうと思いスキー部を始めた時期でした。最後の大会ではたくさん練習したにもかかわらず転んでしまい、いい結果ではありませんでした。しかし一生懸命取り組んだことは一生の宝です。その挑戦経て、今でも私は大変なことにも立ち向かえます。"
    ...
    , "専門学生として見知らぬ土地で生活して1年くらいたったときにたどり着いた至高のラーメン屋です。"
    , "おすすめ：　　　煮干しらぁ麵"
    , "おすすめ：　　　油そばペチカ"]; // 変更したいテキストの配列
